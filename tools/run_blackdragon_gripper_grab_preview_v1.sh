...
OUT_NAME="${OUT_NAME:-thread_gripper_grab_preview_v1}"
...
echo "== Resting pad + gripper grab preview =="
...
PY
    ...
    python3 tools/simulate_gripper_grab_thread_preview.py \
      ...
      --lift-distance 0.006 \
      --close-frames 8
  " 2>&1 | tee "$OUT_NAME/gripper_grab_log.txt"
...
echo "  $PROJECT_DIR/$OUT_NAME/rest/thread_on_pad_resting_newton.obj"
